...
mod tests {
    ...
    fn op_and_two_registers() {
        ...
        vm.reg.update(1, 0b1010101010101010).unwrap(); // SR1
        vm.reg.update(2, 0b1100110011001100).unwrap(); // SR2
        ...
        assert_eq!(vm.reg.get(0).unwrap(), 0b1000100010001000);
    }
    ...
    fn op_and_register_with_immediate() {
        ...
        // Set register
        vm.reg.update(1, 0b1111000011111000).unwrap(); // SR1
        ...
        assert_eq!(vm.reg.get(0).unwrap(), 0b0000000000001000);
    }
    ...
    fn op_and_register_with_sign_extended_immediate() {
        ...
        // Set register
        vm.reg.update(1, 0b1111111111111111).unwrap(); // SR1
    ...
    fn op_and_zero_register() {
        ...
        // Set registers
        vm.reg.update(1, 0b1111111111111111).unwrap(); // SR1
        vm.reg.update(2, 0b0000000000000000).unwrap(); // SR2
